...
// Create an addDefaultData helper. This takes a pointer to a templateData struct,
// adds any required data and then returns the pointer
...
func (app *application) render(w http.ResponseWriter, r *http.Request, name string, td *templateData) {
	...
	// is another time when we pass the http.ReponseWriter to a function that
	// takes an io.Writer.
	buf.WriteTo(w)
}
